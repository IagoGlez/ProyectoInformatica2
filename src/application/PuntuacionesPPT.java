...
public class PuntuacionesPPT {
	public static void display() {
		...
		try {
			 ...
			 rs = stmt.executeQuery("SELECT Puntuaciones.Id_Usuario, Puntuacion, Usuarios.Nombre FROM Puntuaciones LEFT JOIN Usuarios On Puntuaciones.Id_Usuario == Usuarios.ID_Usuario where Id_juego = 2"); //consulta (select, udpate, delete, insert)
